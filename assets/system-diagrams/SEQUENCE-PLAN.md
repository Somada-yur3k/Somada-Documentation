...
- Faculty and Dean approval actions remain separate actor messages inside SEQ-02. Out-of-schedule Class Representative requests still require Faculty then Dean; Faculty out-of-schedule requests require Dean.
