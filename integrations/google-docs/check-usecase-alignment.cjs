...
console.log('Alignment passed: 20 main descriptions (Tables 3–22), 10 supporting use cases / 11 dependencies, 25 events; names, roles, references and numbering match.');
