...
assert.equal(model.flows.length,76);
...
(async()=>{
  ...
  try {
    ...
    console.log('Scope passed: 76 L1 flows, 48 L0 flows, 19 P5 parent flows realized by 20 child exchanges; only Head Lab Daily Tasks, Head Lab last.');
