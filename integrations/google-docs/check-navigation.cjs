...
const files=['index.html','Docs.html','Current-System.html','assets/figures-v2/usecase-diagram-source.html','assets/figures-v2/dfd-level0/dfd-level0-source.html','assets/figures-v2/dfd-level1/dfd-level1-source.html','assets/figures-v2/dfd-level2-compact/dfd-level2-compact.html'];
...
for(const file of files){
 ...
 for(const name of ['Home','Documentation','Current System','Use Case','DFD Level 0','DFD Level 1','DFD Level 2'])assert.equal(await nav.getByRole('link',{name,exact:true}).count(),1,file+' '+name);
