...
const targetId = '11Q2UAiRIxcR_Pc5mb4ieqBvsA-t9Stb759jTH2tizEM';
const seed = ['Cover','I. Project Overview','Original introduction','II. Methodology','Keep this methodology',
  ...
  '3.1.7 Data Flow Diagrams','Old DFD images','3.1.8 Entity-Relationship Diagram','Old ERD'];
...
assert.equal(ok.data.at(-1),'','Trailing paragraph after a final table');
