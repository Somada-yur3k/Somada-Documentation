...
const labels={
 'p2-cr-onschedule':'On-Schedule Request',
 'p2-cr-outschedule':'Out-of-Schedule Request',
 'p2-d2-write':'Reservation Record',
 'p2-d2-read':'Reservation Data'
};
...
for(const f of l1.flows)if(labels[f.id]){f.label=labels[f.id];f.payloadFields=['reservation_type','student_ids'];}
